  ...
  return (
    <GlobalInfoForm title='Reserve Info'>
      <div className='flex flex-col gap-7 h-full justify-center w-11/12 p-14 px-24'>
        ...
        <GlobalText title='Reserve Date:' text={String(reserve.checkDate?.toString().substring(0, 10))} />
        <GlobalText title='Return Date:' text={String(reserve.returnDate?.toString().substring(0, 10))} />
      </div>
    </GlobalInfoForm>
  );
}
